...
shinyUI(
    navbarPage("Shiny Application",
               ...
               tabPanel("Go back to my Github repository",
                        a("https://github.com/DeviTSK/Developing-Data-Products---week-4"),
                        hr(),
                        h4("Hope you find the Shiny App useful"),
                        h4("You may return to the github repository named Developing Data Products --- Week 4")
               )
    )
)